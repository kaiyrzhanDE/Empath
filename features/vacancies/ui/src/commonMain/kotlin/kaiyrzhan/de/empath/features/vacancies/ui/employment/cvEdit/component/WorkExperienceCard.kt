        ...
        Column(
            ...
            OutlinedTextField(
                ...
                onValueChange = { companyName ->
                    onEvent(
                        CvEditEvent.WorkExperienceCompanyChange(
            ...
            OutlinedTextField(
                ...
                onValueChange = { title ->
                    onEvent(
                        CvEditEvent.WorkExperienceTitleChange(
                            id = workExperience.id,
                            title = title,
                        )
                    )
            ...
            OutlinedTextField(
                ...
                onValueChange = { description ->
                    onEvent(
                        CvEditEvent.WorkExperienceDescriptionChange(
                            id = workExperience.id,
            ...
            Row(
                modifier = Modifier.noRippleClickable {
                    onEvent(CvEditEvent.WorkExperienceIsRelevantChange(workExperience.id))
                },
            ...
            Column(
                ...
                Row(
                    ...
                    DatePickerField(
                        ...
                        onClick = {
                            onEvent(
                                CvEditEvent.WorkExperienceStartDateChange(
                                    id = workExperience.id,
                                )
                            )
                        }
                    ...
                    DatePickerField(
                        ...
                        onClick = {
                            onEvent(
                                CvEditEvent.WorkExperienceEndDateChange(
                                    id = workExperience.id,
                                )
                            )
                        }
            ...
            Button(
                ...
                onClick = { onEvent(CvEditEvent.WorkExperienceRemove(workExperience.id)) },
                shape = EmpathTheme.shapes.small,
