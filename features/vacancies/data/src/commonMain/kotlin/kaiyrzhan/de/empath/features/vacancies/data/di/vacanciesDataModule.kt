...
import kaiyrzhan.de.empath.features.vacancies.data.remote.createEmploymentApi
...
import kaiyrzhan.de.empath.features.vacancies.data.repository.EmploymentRepositoryImpl
...
public val vacanciesDataModule: Module = module {
    ...
    single<EmploymentApi> { get<Ktorfit>().createEmploymentApi() }
    ...
    single<EmploymentRepository> {
        EmploymentRepositoryImpl(
            api = get<EmploymentApi>()
        )
    }
}